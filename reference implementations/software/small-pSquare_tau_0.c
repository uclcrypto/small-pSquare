...
int Encrypt(const uint8_t *plaintext, const uint8_t* key, uint8_t *ciphertext)
{
    uint8_t state[16];
...
int Decrypt(const uint8_t *ciphertext, const uint8_t* key, uint8_t *plaintext)
{
    uint8_t state[16];
    uint8_t round_tweakey[16];
    uint64_t pi = 0xC90FDAA22168C234;
